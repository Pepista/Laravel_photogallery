...
<div class="container">
    ...
    <section>
        ...
        <form action="{{ route('admin.upload') }}" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" name="description" placeholder="Enter image description" class="form-input" maxlength="255">
            <button type="submit" class="form-btn">Upload Image</button>
        </form>
    </section>
